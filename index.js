...
app.post('/actions', urlencodedParser, function (req, res) {
  ...
  let text = updateTextWithVote(actionJSONPayload.original_message.attachments[0].text, actionJSONPayload.actions[0].value, actionJSONPayload.user.id)
  var message = {
    "response_type": "in_channel",
...
function updateTextWithVote(text, vote, user) {
  ...
  console.log(optionToUpdate, hasUsers, optionText, userText)
  let updatedOption = usersWhoVotedForOption.length > 0 ?
